========================================================================
    KONSOLENANWENDUNG: uebung02Klassen-Projektübersicht
========================================================================

Diese uebung02Klassen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre uebung02Klassen-Anwendung besteht.


uebung02Klassen.vcxproj
...
uebung02Klassen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen uebung02Klassen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
