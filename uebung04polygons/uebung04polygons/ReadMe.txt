========================================================================
    KONSOLENANWENDUNG: uebung04polygons-Projektübersicht
========================================================================

Diese uebung04polygons-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre uebung04polygons-Anwendung besteht.


uebung04polygons.vcxproj
...
uebung04polygons.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen uebung04polygons.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
