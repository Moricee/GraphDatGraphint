	...
	: QWidget(parent)
{
	...
	btnDrawPoints = new QPushButton("&Draw Points");
	...
	mainLayout->addWidget(btnDrawPoints, 3, 1, 1, 2, Qt::AlignRight);
	...
	// connect button click event to draw handler
	connect(btnDrawPoints, SIGNAL(clicked()), this, SLOT(drawBtnPressed()));
...
/* method for handling draw button clicked event*/
void Paint::drawBtnPressed()
{
	viewport->setPoints();
